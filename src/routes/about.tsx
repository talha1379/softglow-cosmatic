...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About GlowAI — Clean Beauty Powered by AI" },
    ...
    <Layout>
      <section className="bg-hero-gradient py-20">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="text-lg text-muted-foreground">We started GlowAI with one belief: every skin deserves a routine as unique as its owner. By blending dermatology with AI, we make personalized beauty effortless.</p>
        </div>
      </section>
